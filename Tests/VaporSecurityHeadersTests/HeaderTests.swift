...
//        XCTAssertEqual(expectedCSPHeaderValue, response.headers[.contentSecurityPolicy])
//        XCTAssertEqual(expectedXFOHeaderValue, response.headers[.xFrameOptions])
//        XCTAssertEqual(expectedXSSProtectionHeaderValue, response.headers[.xXssProtection])
...
//        let response = try drop.respond(to: request)
//
//        XCTAssertEqual("default-src 'none'", response.headers[.contentSecurityPolicy])
        XCTAssertTrue(false)
    }
